...
class Ui_DesignDocumentEditForm(object):
    def setupUi(self, DesignDocumentEditForm):
        DesignDocumentEditForm.setObjectName("DesignDocumentFillingForm")
        DesignDocumentEditForm.resize(1027, 791)
        ...
        self.retranslateUi(DesignDocumentEditForm)
        QtCore.QMetaObject.connectSlotsByName(DesignDocumentEditForm)


    def retranslateUi(self, DesignDocumentEditForm):
        _translate = QtCore.QCoreApplication.translate
        DesignDocumentEditForm.setWindowTitle(_translate("DesignDocumentFillingForm", "MainWindow"))

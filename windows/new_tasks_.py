...
class Ui_NewTasks(object):
    def setupUi(self, NewTasks):
        ...
        self.pushButton_12 = QtWidgets.QPushButton("Новое задание")
        ...
        self.layoutTask = QtWidgets.QVBoxLayout()  # Добавьте этот атрибут
        self.verticalLayout_2.addLayout(self.layoutTask)  # Добавьте layout в интерфейс
...
class NewTasks(QtWidgets.QMainWindow):
    def __init__(self, parent):
        ...
        # Подключаем обработчик нажатия на кнопку "Новое задание"
        self.ui.pushButton_12.clicked.connect(self.open_order_dev)

    # def open_order_dev(self):
    #     """Переключение на окно OrderDev"""
    #     self.parent.switch_window(self.parent.order_dev_window)

    def open_order_dev(self):
        self.new_window = OrderDev()  # Создаем экземпляр нового окна

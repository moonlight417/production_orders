...
class Ui_SearchDesignDoc(object):
    def setupUi(self, SearchDesignDoc):
        ...
        self.labelSearchByTag = QtWidgets.QLabel(self.centralwidget)
        self.labelSearchByTag.setGeometry(QtCore.QRect(410, -1, 71, 20))
        self.labelSearchByTag.setObjectName("labelSearchByTag")
        self.lineEditSearchByTag = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.BtnSearchByTag = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.scrollArea.setGeometry(QtCore.QRect(10, 50, 721, 561))
        self.scrollArea.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 702, 559))

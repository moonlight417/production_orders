...
"border-color: rgb(0, 0, 0);")
        ...
        icon.addPixmap(QtGui.QPixmap("../utils/x-square.svg"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"border-color: rgb(0, 0, 0);")
        ...
        icon1.addPixmap(QtGui.QPixmap("../utils/icons/plus-square-dotted.svg"), QtGui.QIcon.Selected, QtGui.QIcon.On)
